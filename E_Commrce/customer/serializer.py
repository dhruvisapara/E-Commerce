...
class BusinessUserSerializer(ModelSerializer):
    ...
    #
    #     """
    #     It should validate that company is registered or not
    #     And company revenue must be greater than 50k.
    #     """
    #
    #     if Business.objects.filter(company_name=data["company_name"]).exists():
...
class StaffMembersSerializer(ModelSerializer):
    ...
    def update(self, instance, validated_data):
        """
        manager can create and update and delete staff members.
        """
        staff_members = validated_data.pop("staff_members")
